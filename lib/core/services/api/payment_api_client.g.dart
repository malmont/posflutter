...
class _PaymentApiClient implements PaymentApiClient {
  ...
  Future<List<PaymentDetailsModel>> getPayments(
    ...
    final _options = _setStreamType<List<PaymentDetailsModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<PaymentDetailsModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<PaymentsStatisticsModel> getPaymentStatistique() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentsStatisticsModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late PaymentsStatisticsModel _value;
    try {
      _value = PaymentsStatisticsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
